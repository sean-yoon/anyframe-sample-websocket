 ...
 */
package com.anyframe.sample.common.aspect;

import java.util.Locale;

import javax.inject.Inject;

import com.anyframe.sample.common.MovieFinderException;
...
public class ExceptionTransfer {
	...
	@AfterThrowing(pointcut = "execution(* com.anyframe.sample.servlet..*Impl.*(..)) "
	...
	public void transfer(JoinPoint thisJoinPoint, Exception exception) throws MovieFinderException {
		...
		try {
			logger.error(
					messageSource.getMessage("error." + className + "." + opName, new String[] {}, Locale.getDefault()),
					exception);
		} catch (Exception e) {
